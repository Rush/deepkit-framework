 ...
 */
import { collectForMicrotask, getClassName, getClassPropertyName, isArray, isPlainObject, isPrototypeOfBase, toFastProperties } from '@deepkit/core';
...
export function createNewPropertySchemaIfNecessary(result, property, fromPromise = false) {
